...
public abstract class BaseIndicaorBanner<E, T extends BaseIndicaorBanner<E, T>> extends BaseBanner<E, T> {
    ...
    public BaseIndicaorBanner(Context context, AttributeSet attrs, int defStyle) {
        ...
        indicatorHeight = ta.getDimensionPixelSize(R.styleable.BaseIndicaorBanner_bib_indicatorHeight, dp2px(3));
        indicatorGap = ta.getDimensionPixelSize(R.styleable.BaseIndicaorBanner_bib_indicatorGap, dp2px(6));
        indicatorCornerRadius = ta.getDimensionPixelSize(R.styleable.BaseIndicaorBanner_bib_indicatorCornerRadius, dp2px(10));
...
//            imageView.setImageResource(indicatorBg);
//            imageView.setLayoutParams(new FrameLayout.LayoutParams(FrameLayout.LayoutParams.MATCH_PARENT, FrameLayout.LayoutParams.MATCH_PARENT));
//            frameLayout.addView(imageView);
//        }

//        frameLayout.addView(ll_indicators);
