...
public class SerialPortManager extends SerialPort implements ISerPort {
    ...
    @Override
    public byte[] sendAndWaitBackLongData(byte[] data, int timeoutfirst, int timeoutlast) {
        // /清空接收缓冲数据
