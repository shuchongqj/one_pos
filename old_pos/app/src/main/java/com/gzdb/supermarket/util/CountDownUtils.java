...
//    }
     ...
     * @param totalSeconds
     */
    public static String getData(long totalSeconds) {
        resetData();

        day = totalSeconds / (24 * 60 * 60 );

        hour = totalSeconds / (60 * 60) - day * 24;

        minute = totalSeconds / 60 - day * 24 * 60 - hour * 60;

        return day + "天" + hour + "小时" + minute
                + "分钟";
    }

    public static String getData2(long totalSeconds) {
        resetData();
