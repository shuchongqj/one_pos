...
public class Contonts {
    ...
    public static final String homeurl = BuildConfig.BASE_URL;
    public static final String b_base_url = BuildConfig.B_BASE_URL;                                                     //B端主域名
    ...
    public static final String URL_SETTLEMENT_COUNT = homeurl + "pos/settlement/settlement_order/settlement_shift";     //结算按钮
    ...
    //VIP会员，获取会员信息
    public static final String offlinemember_getmemberinfo = b_base_url + "pos/offlinemember/getmemberinfo";

    //VIP会员，发送验证码
    public static final String offlinemember_sendcode = b_base_url + "pos/offlinemember/sendcode";

    //VIP会员，会员充值
    public static final String offlinemember_reg = b_base_url + "pos/offlinemember/reg";

    //VIP会员，获取token
    public static final String customer_base_gettoken = b_base_url + "customer/base/gettoken";

    //创建充值订单，VIP会员
    public static final String customer_vipuser_vipuserpay = b_base_url + "customer/vipuser/vipuserpay";

    //
    public static final String vipuserpaycallback_offline = b_base_url + "vipuserpaycallback/offline";

    //获取会员卡支付编码
    public static final String customer_pay_getcode = b_base_url + "customer/pay/getcode";


    public static final String itemPeriodDiscountQuery = homeurl + "pos/menu/posItem/itemPeriodDiscountQuery";
}
