...
/**
 * Created by yangyifan on 15/5/11.
 */
public class Arith {
     ...
     * @return 两个参数的差
     */
    public static double del(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(Double.toString(v1));
        BigDecimal b2 = new BigDecimal(Double.toString(v2));
        return round(b1.subtract(b2).doubleValue(),2);
    }
    public static double del(String v1, String v2) {
    ...
    public static double mul(String v1, String v2) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        LogUtils.e(b1.multiply(b2).doubleValue()+"");
        return round(b1.multiply(b2).doubleValue(),2);
    }
