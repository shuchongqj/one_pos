...
public class AddItemActivity extends BaseActivity implements View.OnClickListener {
    ...
    private String initStartDateTime = "2017年01月01日"; // 初始化开始时间
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dialog = DialogUtil.loadingDialog(this, "请稍候");
        showdialog = DialogUtil.loadingDialog(this, "正在提交");
        initView();
    }
    ...
    private void initView() {
        ...
        dateOfManufacture.setText("2018年01月01日");
        dateOfManufacture.setOnClickListener(this);
    ...
    public void onClick(View v) {
        int id = v.getId();
        if (id == R.id.add_type) {
            Intent intent = new Intent(AddItemActivity.this, AddItemTypeActivity.class);
        ...
        if (id == R.id.date_of_manufacture) {
            onYearMonthDayPicker();
        }

        if (id == R.id.add_unit) {
            Intent intent = new Intent(AddItemActivity.this, AddItemUnitActivity.class);
    ...
    public void search() {
        ...
        OkGo.<NydResponse<GoodListBean>>post(Contonts.URL_ADD_FIND_GOOD)
                ...
                .execute(new DialogCallback<NydResponse<GoodListBean>>(this) {
                    @Override
                    public void onSuccess(com.lzy.okgo.model.Response<NydResponse<GoodListBean>> response) {
                        ...
                        Intent intent = new Intent(AddItemActivity.this, SearchItemActivity.class);
    ...
    private void setSubmit() {
        ...
        httpParams.put("barcode", goodsCode.getText().toString().trim());//商品的条码 "070330611641"
        ...
        httpParams.put("itemUnitId", unitBean.getId());
        ...
        httpParams.put("repertory", stock.getText().toString());//库存
        httpParams.put("warningRepertory", editWarnInventory.getText().toString());//预警库存
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent intent) {
        ...
        if (resultCode == 100) {
            ...
            //弹出提示
            ToastUtil.showToast(AddItemActivity.this, "分类创建成功");
...
//            newItemUnits.add(itemType);
            //弹出提示
            ToastUtil.showToast(AddItemActivity.this, "单位创建成功");
        }
    }
    ...
    private boolean setIsNull() {
        ...
        if (classification == null || classification.getSelectedItem() == null || classification.getSelectedItem().getXCDropDownItemType() == 0 || classification.getSelectedItem().getXCDropDownItemText().equals("-选择商品分类-")) {
            ToastUtil.showToast(this, "请选择商品分类");
            return false;
        }
        if (unit == null || unit.getSelectedItem() == null || unit.getSelectedItem().getXCDropDownItemType() == 0 || unit.getSelectedItem().getXCDropDownItemText().equals("-选择商品单位-")) {
            ToastUtil.showToast(this, "请选择商品单位");
            return false;
        }
        return true;
    }
