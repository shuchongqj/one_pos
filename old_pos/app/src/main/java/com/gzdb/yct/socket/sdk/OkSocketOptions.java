package com.gzdb.yct.socket.sdk;

import java.nio.ByteOrder;

import com.gzdb.yct.socket.sdk.connection.AbsReconnectionManager;
import com.gzdb.yct.socket.sdk.connection.DefaultReconnectManager;
import com.gzdb.yct.socket.sdk.connection.NoneReconnect;
import com.gzdb.yct.socket.sdk.connection.abilities.IConfiguration;
import com.gzdb.yct.socket.sdk.protocol.DefaultNormalHeaderProtocol;
...
public class OkSocketOptions {
     ...
     * 抛出{@link com.gzdb.yct.socket.impl.exceptions.DogDeadException}
     */
    ...
    public static class Builder {
         ...
         * 脉搏丢失次数<br>
         * 大于或等于丢失次数时将断开该通道的连接<br>
         * 抛出{@link com.gzdb.yct.socket.impl.exceptions.DogDeadException}<br>
         * 默认是5次
         *
    ...
    public static OkSocketOptions getDefault() {
        ...
        okOptions.mWritePackageBytes = 2048;
        okOptions.mReadPackageBytes = 2048;
        okOptions.mReadByteOrder = ByteOrder.BIG_ENDIAN;
        okOptions.mWriteOrder = ByteOrder.BIG_ENDIAN;
        okOptions.isConnectionHolden = false;
