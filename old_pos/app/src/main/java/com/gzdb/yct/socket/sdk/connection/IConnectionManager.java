package com.gzdb.yct.socket.sdk.connection;

import com.gzdb.yct.socket.impl.PulseManager;
import com.gzdb.yct.socket.sdk.ConnectionInfo;
import com.gzdb.yct.socket.sdk.connection.abilities.IConfiguration;
import com.gzdb.yct.socket.sdk.connection.abilities.IConnectable;
import com.gzdb.yct.socket.sdk.connection.abilities.IDisConnectable;
import com.gzdb.yct.socket.sdk.connection.abilities.IRegister;
import com.gzdb.yct.socket.sdk.connection.abilities.ISender;
