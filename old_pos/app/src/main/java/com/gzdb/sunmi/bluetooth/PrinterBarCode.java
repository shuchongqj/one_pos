...
import com.core.printer.CodePrintDataMaker;
...
public class PrinterBarCode {
    ...
    public static void outcomeTacket(GoodBean o) {
    ...
    // --------------------
    public static byte[] generateMockData(GoodBean bean) {
        return ESCUtil.byteMerger(new CodePrintDataMaker(context, "", 500, 255, bean).getPrintData(PrinterWriter80mm.TYPE_80).toArray(new byte[][]{}));
    }
}
