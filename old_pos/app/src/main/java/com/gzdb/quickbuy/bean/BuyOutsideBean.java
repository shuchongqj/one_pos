...
public class BuyOutsideBean {


    private String standardInventory;
    ...
    private static final Map<Integer,List<BuyOutsideBean>> itemListMap = new HashMap<>();
    ...
    public String getStandardInventory() {
        return standardInventory;
    }

    public void setStandardInventory(String standardInventory) {
     ...
     *  根据商品类型ID 获取一堆商品
     */
    public static List<BuyOutsideBean> gets(int menuTypeId){
