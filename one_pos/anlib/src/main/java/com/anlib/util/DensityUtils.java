...
public class DensityUtils {
    ...
    public static int dp2px(float dpValue) {
        final float scale = GApplication.getDisplayMetrics().density;
    ...
    public static int sp2px(float spValue) {
        final float fontScale = GApplication.getDisplayMetrics().scaledDensity;
    ...
    public static int getScreenWidth() {
        return GApplication.getDisplayMetrics().widthPixels;
    }
    ...
    public static int getScreenHeight() {
        return GApplication.getDisplayMetrics().heightPixels;
    }
    ...
    public static int getScreenRealHeight() {
        int h;
        WindowManager winMgr = (WindowManager) GApplication.getContext().getSystemService(Context.WINDOW_SERVICE);
    ...
    public static int getStatusBarHeight() {
        ...
        try {
            ...
            statusBarHeight = GApplication.getContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
    ...
    public static int getNavigationBarHeight() {
        ...
        Resources resources = GApplication.getContext().getResources();
